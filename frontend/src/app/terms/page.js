    ...
    <>
      <section className="bg-guardian-void relative overflow-hidden py-20">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white font-display">Terms of Use</h1>
          <p className="text-xl text-neutral-300 max-w-3xl mx-auto">Guidelines and terms governing the use of The Protectors website and services.</p>
        </div>
      </section>
      ...
      <section className="section bg-guardian-midnight">
        <div className="container-custom max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              { title: '1. Acceptance of Terms', content: 'By accessing or using The Protectors website (the "Site"), you agree to be bound by these Terms of Use. If you do not agree with any part of these terms, you must not use the Site. These terms constitute a legally binding agreement between you and The Protectors.' },
              { title: '2. Our Mission & Ethical Standards', content: 'The Protectors is a Canadian nonprofit organization committed to community safety, victim support, and violence prevention through lawful means. By using this Site, you agree to:', list: ['Not use the Site to encourage or engage in harassment, vigilantism, or targeting of individuals', 'Not publish accusations or personal information about alleged offenders', 'Report criminal activity to law enforcement authorities, not to this platform', 'Respect the privacy and dignity of all individuals, including survivors and community members', 'Use the Site in compliance with all applicable Canadian federal and provincial laws'] },
              ...
              { title: '4. Intellectual Property', content: 'All content on the Site, including text, graphics, logos, images, and software, is the property of The Protectors or its content providers and is protected by Canadian and international copyright laws. You may not reproduce, distribute, modify, or create derivative works without our prior written consent.' },
              { title: '5. Limitation of Liability', content: 'The Protectors provides the Site and its content on an "as is" and "as available" basis. We make no representations or warranties of any kind, express or implied, regarding the operation or availability of the Site. To the fullest extent permitted by Canadian law, The Protectors disclaims all liability for any damages arising from the use or inability to use the Site.' },
              { title: '6. Third-Party Links', content: 'The Site may contain links to third-party websites or services that are not owned or controlled by The Protectors. We are not responsible for the content, privacy practices, or terms of use of any third-party sites. We encourage you to review the terms and privacy policies of any third-party sites you visit.' },
